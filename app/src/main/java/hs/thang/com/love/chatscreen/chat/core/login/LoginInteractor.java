package hs.thang.com.love.chatscreen.chat.core.login;
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            updateFirebaseToken(task.getResult().getUser().getUid(),
                                    SharedPrefUtil.getInstance(activity.getApplicationContext()).getString(Constants.ARG_FIREBASE_TOKEN, null));
                        } else {
