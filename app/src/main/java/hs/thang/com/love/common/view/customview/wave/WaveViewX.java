 ...
 */
package hs.thang.com.love.common.view.customview.wave;
...
public class WaveViewX extends View {
    /**
     * +------------------------+
     * |<--wave length->        |______
     * |   /\          |   /\   |  |
    ...
    public WaveViewX(Context context) {
        super(context);
        init();
    }

    public WaveViewX(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WaveViewX(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setBorder(int width, int borderColor) {
